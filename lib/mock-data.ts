...
export const COHORTS: Record<string, AdCohort[]> = {
  myyk: [
    { cohortDate: "2025-09-01", label: "Sep 25", adCount: 4, weeks: makeWeeks(38, 18, 1.8, 104, 196, 4.2, 28000, 8) },
    { cohortDate: "2025-10-01", label: "Okt 25", adCount: 6, weeks: makeWeeks(42, 21, 2.0, 108, 188, 4.4, 34000, 7) },
    { cohortDate: "2025-11-01", label: "Nov 25", adCount: 5, weeks: makeWeeks(36, 16, 1.6, 112, 208, 4.0, 42000, 6) },
    { cohortDate: "2025-12-01", label: "Des 25", adCount: 7, weeks: makeWeeks(29, 12, 1.2, 124, 242, 3.6, 48000, 5) },
    { cohortDate: "2026-01-01", label: "Jan 26", adCount: 5, weeks: makeWeeks(44, 22, 2.1, 106, 184, 4.6, 36000, 4) },
    { cohortDate: "2026-02-01", label: "Feb 26", adCount: 8, weeks: makeWeeks(48, 24, 2.4, 102, 176, 4.8, 38000, 3) },
    { cohortDate: "2026-03-01", label: "Mar 26", adCount: 6, weeks: makeWeeks(52, 26, 2.6, 98, 168, 5.1, 44000, 2) },
  ],
  kokkeloren: [
    { cohortDate: "2025-10-01", label: "Okt 25", adCount: 3, weeks: makeWeeks(56, 28, 2.8, 82, 142, 5.8, 22000, 7) },
    { cohortDate: "2025-11-01", label: "Nov 25", adCount: 5, weeks: makeWeeks(62, 31, 3.1, 78, 136, 6.1, 28000, 6) },
    { cohortDate: "2025-12-01", label: "Des 25", adCount: 4, weeks: makeWeeks(48, 24, 2.4, 88, 158, 5.2, 32000, 5) },
    { cohortDate: "2026-01-01", label: "Jan 26", adCount: 6, weeks: makeWeeks(68, 34, 3.4, 74, 128, 6.6, 24000, 4) },
    { cohortDate: "2026-02-01", label: "Feb 26", adCount: 4, weeks: makeWeeks(72, 36, 3.6, 72, 122, 6.9, 26000, 3) },
    { cohortDate: "2026-03-01", label: "Mar 26", adCount: 7, weeks: makeWeeks(78, 39, 3.9, 68, 116, 7.2, 28000, 2) },
  ],
  farfar: [
    { cohortDate: "2025-08-01", label: "Aug 25", adCount: 8, weeks: makeWeeks(28, 12, 1.0, 128, 298, 2.8, 48000, 9) },
    { cohortDate: "2025-09-01", label: "Sep 25", adCount: 6, weeks: makeWeeks(24, 10, 0.9, 132, 318, 2.6, 52000, 8) },
    { cohortDate: "2025-10-01", label: "Okt 25", adCount: 9, weeks: makeWeeks(32, 14, 1.2, 126, 288, 2.9, 58000, 7) },
    { cohortDate: "2025-11-01", label: "Nov 25", adCount: 7, weeks: makeWeeks(26, 11, 1.0, 134, 308, 2.7, 62000, 6) },
    { cohortDate: "2025-12-01", label: "Des 25", adCount: 5, weeks: makeWeeks(22, 9, 0.8, 142, 342, 2.4, 68000, 5) },
    { cohortDate: "2026-01-01", label: "Jan 26", adCount: 8, weeks: makeWeeks(34, 15, 1.3, 124, 278, 3.0, 54000, 4) },
    { cohortDate: "2026-02-01", label: "Feb 26", adCount: 6, weeks: makeWeeks(38, 17, 1.4, 118, 264, 3.2, 48000, 3) },
    { cohortDate: "2026-03-01", label: "Mar 26", adCount: 10, weeks: makeWeeks(42, 19, 1.6, 114, 252, 3.4, 44000, 2) },
  ],
};
